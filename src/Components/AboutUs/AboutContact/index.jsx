        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-700 text-lg">
            ...
            <li className="flex items-center gap-3">
              ...
              <a href="tel:+919992229143" className="hover:underline">+91 99909 39208</a>
            </li>
            <li className="flex items-center gap-3">
              <WhatsAppIcon className="text-green-600" />
              <a href="https://wa.me/919992229143" target="_blank" rel="noopener noreferrer" className="hover:underline">
                Chat on WhatsApp
              </a>
            </li>
            <li className="flex items-center gap-3">
